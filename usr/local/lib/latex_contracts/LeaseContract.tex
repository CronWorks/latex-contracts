    ...
    \section{Terms of Lease Agreement}
        ...
        \clause[Security Deposit]{%
            ...
            [[[else]]]%
                ...
                in the amount of \highlight{((( contract.property.deposit|escapeTex )))} as a combined
        ...
        \clause[Rent]{
            ...
            The Tenant is moving in on a date other than the first of the month;
            a pro-rated amount for the remaining portion of the first month will be due upon occupation of the
            Property.
        }
